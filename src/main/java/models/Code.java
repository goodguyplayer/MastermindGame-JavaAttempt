...
public class Code {
    ...
    /**
     * method that generates random numbers, from 97 to 122, ascii.
     * @return A random int that goes from 97 to 122
     * @author Nathan (goodguyplayer)
     */
     ...
     * Since the range is 97 to 122, the letters are lowercase.
